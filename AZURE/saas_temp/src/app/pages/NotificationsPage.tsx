...
const notifications = [
  {
    ...
    message: "Wireless Headphones Pro has only 12 units remaining in stock",
    time: "5 minutes ago",
    read: false,
  },
  {
    ...
    message: "Order #12847 has been successfully shipped to customer",
    time: "1 hour ago",
    read: false,
  },
  {
    ...
    message: "200 units of Smart Watch Series 5 have been added to inventory",
    time: "3 hours ago",
    read: true,
  },
  {
    ...
    message: "Congratulations! You've reached $150,000 in monthly revenue",
    time: "5 hours ago",
    read: true,
  },
  {
