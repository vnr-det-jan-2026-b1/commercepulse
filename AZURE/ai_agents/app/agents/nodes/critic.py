...
"""
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            llm = ChatGroq(api_key=key, model="llama-3.3-70b-versatile", temperature=0.0).with_fallbacks([ChatGroq(api_key=key, model="llama3-8b-8192", temperature=0.0)]).with_config(tags=["critic"])
